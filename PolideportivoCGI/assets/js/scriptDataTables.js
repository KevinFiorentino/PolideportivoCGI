...
function detalleFilial(d) {
	...
	+'<!-- INICIO MODAL --><div class="container"><!-- Modal --><div class="modal fade" id="modFilial" role="dialog"><div class="modal-dialog"> '
			...
			+'<select class="form-control" name="hasta"><option value="" selected="" disabled>--</option><option value="00">00:00 hs</option><option value="01">01:00 hs</option>'
			...
			+'<div class="tab-content col-sm-6"><div class="form-group"><label for="hasta"><strong>Horario Hasta:</strong> '+d.horarioHasta+'</label><select class="form-control" name="desde">'
			...
			+'<select class="form-control" name="mantenimiento"><option value="" selected="" disabled>--</option><option value="0">Domingo</option><option value="1">Lunes</option>'
